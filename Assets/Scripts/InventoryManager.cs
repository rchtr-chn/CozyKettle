...
public class InventoryManager : MonoBehaviour
{
    ...
    */
    ...
    {
        SeedCounts[0] = InventoryData.BlackSeedQuantity;
        SeedCounts[1] = InventoryData.GreenSeedQuantity;
        SeedCounts[2] = InventoryData.MatchaSeedQuantity;
        SeedCounts[3] = InventoryData.OolongSeedQuantity;
    }
    ...
    {
        InventoryData.BlackSeedQuantity = SeedCounts[0];
        InventoryData.GreenSeedQuantity = SeedCounts[1];
        InventoryData.MatchaSeedQuantity = SeedCounts[2];
        InventoryData.OolongSeedQuantity = SeedCounts[3];
    }
